...
const inputUrl = (props) => {
  ...
  const inputClasses = ['outline-none  w-full bg-transparent border-b-solid border-b-2 text-white'];
  ...
  if (props.invalid && props.touched) {
    ...
    errorMessage = <p className={errorFeedBackClasses}>Please enter a valid URL</p>;
  } else {
